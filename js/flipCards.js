...
//                             <a href='${card.href}' class="mt-4 py-2 px-4 bg-[rgb(2,1,142)] dark:bg-gray-800 text-white dark:text-gray-100 border-2 border-white dark:border-gray-600 rounded">Daha ətraflı</a>
//                         </div>
//                     </div>
//         `;
