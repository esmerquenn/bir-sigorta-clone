...
`,
  ...
  <div class="mt-5 md:text-[1.2rem] text-[#f0f0f0] dark:text-gray-400">
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">Что такое страхование?</h3>
      <p>
    ...
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">Что такое страховой договор?</h3>
      <p>
    ...
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">Что такое страховая премия?</h3>
      <p>
    ...
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">Кто такой страховщик?</h3>
      <p>
    ...
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">Кто такой страхователь?</h3>
      <p>
    ...
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">Что такое франшиза и как она влияет на страховую премию?</h3>
      <p>
    ...
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">Какие риски покрывает автомобильное страхование?</h3>
      <p>
    ...
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">Как определяется стоимость автомобиля при его страховании?</h3>
      <p>
    ...
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">На какой срок заключается договор автомобильного страхования?</h3>
      <p>
    ...
    <article class="mb-6">
      <h3 class="text-2xl font-semibold mb-2 text-[#f0f0f0] dark:text-gray-300">Могу ли я застраховать автомобиль, который управляю по доверенности?</h3>
      <p>
...
`,
  ...
  <div class="mb-10">
    <h2 class="text-2xl md:text-3xl font-semibold text-white mb-2">Продажи Страхования и Обслуживание Клиентов</h2>
    <div class="h-1 bg-[#EA1918] w-full mb-4"></div>
    <ul class="mt-4 md:text-[1.2rem] text-white list-disc pl-5">
  ...
  <div class="mb-10">
    <h2 class="text-2xl md:text-3xl font-semibold text-white mb-2">Финансы и Экономика</h2>
    <div class="h-1 bg-[#EA1918] w-full mb-4"></div>
    <ul class="mt-4 md:text-[1.2rem] text-white list-disc pl-5">
  ...
  <div class="mb-10">
    <h2 class="text-2xl md:text-3xl font-semibold text-white mb-2">Информационные Технологии (ИТ)</h2>
    <div class="h-1 bg-[#EA1918] w-full mb-4"></div>
    <ul class="mt-4 md:text-[1.2rem] text-white list-disc pl-5">
  ...
  <div class="mb-10">
    <h2 class="text-2xl md:text-3xl font-semibold text-white mb-2">Маркетинг и Коммуникации</h2>
    <div class="h-1 bg-[#EA1918] w-full mb-4"></div>
    <ul class="mt-4 md:text-[1.2rem] text-white list-disc pl-5">
